...
const MERAGI_DETAILS_BASE = "https://www.meragi.com/venue-details/"; // fallback pattern
...
async function resolveWorkingMeragiUrl(name, preferredUrl) {
  ...
  for (const slug of buildSlugVariants(name || "")) {
    ...
    candidates.push(`${MERAGI_DETAILS_BASE}${slug}/`);
  }
  const seen = new Set();
...
const KNOWN_MERAGI_SLUGS = [
  // Page 1 — original 25
  "royalton-leisure-jiva", "tridalam", "ananda-farms", "the-lily-pond",
  "naveraa-resort-and-event-centre", "eden-farms", "milana-greens",
  "brindavan-bliss", "devprayag", "socials-farm", "olde-bangalore-resort",
  "srishti-vilasa", "suvi-retreat", "magnolia-by-jade",
  "fiestaa-resort-n-events-venue", "mlr-convention-centre-j-p-nagar",
  "the-park-bangalore", "gokulam-grand-hotel-spa", "chairmans-jade-devanahalli",
  "ankit-vista-green-village-resorts-and-hotels", "royalton-leisure-aria",
  "the-quad-club-resort-and-spa", "mantra-the-luxury-wedding-destination",
  "sahasra-vaibogham-the-events-celebrations-venue", "the-beginning-wedding-venue",
  // Additional from Google searches
  "moongate-events-venue", "prangana", "jkr-farm-and-resort",
  "melam-wedding-hall", "royal-lotus-view-restol", "chathurthi-farms",
  "sambrama-by-swanlines", "nakshatra-events-venue", "aaditya-greens",
  "harikaa-resorts",
  // Pages 2-7 — new venues
  ...
  "golden-amoon-premium-resort-and-spa",
  "ravishing-retreat",
  ...
  "tranquil-woods-by-jade",
  "the-peacock-grove",
  "woodrose-club",
  "the-ritz-carlton-bangalore",
  "valura-wedding-venue",
  "the-haven-by-jade",
  "hilton-bengaluru-embassy-manyata-business-park",
  "nesara-centre-for-culture",
  ...
  "peninsula-suites-by-lemon-tree-hotels-whitefield",
  ...
  "white-pearl-jigani-convention-hall",
  "hotel-royal-orchid-domlur",
  "augusta-club-brigade-gardenia",
  "meridian-by-the-lawns",
  "discovery-village-nandi-foot-hills",
  "mandara-weddings-and-events-venue",
  "mandara-khedda-resort-weddings-and-events-venue",
  "conrad-bengaluru",
  "tamarind-tree",
  "radiant-resort",
  "the-pergola-yeshwantpur",
  "ritam-the-wedding-venue",
  "vara-the-pavilion",
  "the-finer-side",
  ...
  "miraya-greens",
  "amita-rasa",
  "backyard-by-farmhouse-collective",
  "ramanashree-california-resort",
  "golden-palms-hotel-and-spa",
  "rivi-by-nityotsava",
  "signature-club-resort",
  "amara-convention-hall",
  "royal-orchid-resort-and-convention-centre-yelahanka",
  "trinity-whitefield-bengaluru",
  "vanya-luxury-boutique-resort",
  "bliss-convention-center",
  "geethanjali-wedding-venue",
  "white-petals-palace-grounds",
  "le-roma-vista",
  "shree-swarga-heritage-wedding-venue",
  "ranch-at-big-banyan-vineyard-and-resort",
  "the-secret-mirage",
  "house-of-pillars",
  "the-white-hall",
  "mulberry-shades-bengaluru-nandi-hills",
  "the-event-grove-whitefield",
  "isle-by-wonderla",
  "bougainvilla-celebrate-luxury",
  "the-secret-grove",
