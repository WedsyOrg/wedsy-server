/**
 * META APP-REVIEW REVIEWER ACCOUNT — the guard, the Disconnect rule, the scope.
 *
 * Three things have to hold, and two of them are production-critical well
 * beyond this one account:
 *
 ...
 *
 *   node tests/meta-reviewer-account.test.js
 */
...
console.log("\n3. SCOPE — `leads:view:own` is what hides real clients");
{
