...
const LaneEntrySchema = new mongoose.Schema(
  {
    ...
    autoType: {
      type: String,
      enum: ["", "call_logged", "meeting_booked", "task_done", "lane_woken", "proposal_sent", "agreement", "payment", "lane_opened", "owner_changed", "brief_saved", "lane_priced", "engagement_sent", "meeting_updated"],
      default: "",
    },
